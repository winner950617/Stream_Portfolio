...
import {
  BiLogoHtml5, BiLogoGit, BiLogoGithub, BiLogoRedux, BiLogoCss3, BiLogoBootstrap, BiLogoTailwindCss, BiLogoJavascript,
  BiLogoReact, BiLogoNodejs, BiLogoJava, BiLogoMongodb, BiVideo, BiCamera, BiLogoPython
} from 'react-icons/bi'
    ...
    <section className='mb-48 flex min-h[70vh] w-full flex-col items-center justify-center gap-16 md:gap-30 scroll-mt-40' id='tech'>
      ...
      <div className='flex flex-wrap items-center justify-center gap-7 p-2 pt-0'>
        ...
        <motion.div variants={variants} initial="hidden" whileInView="visible" transition={{ duration: 0.5 }}>
          <BiLogoPython className='cursor-pointer text-[80px] text-green-500 transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[100px]' />
        </motion.div>

        <motion.div variants={variants} initial="hidden" whileInView="visible" transition={{ duration: 0.5 }}>
          <BiVideo className='cursor-pointer text-[80px] text-yellow-500 transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[100px]' />
        </motion.div>

        <motion.div variants={variants} initial="hidden" whileInView="visible" transition={{ duration: 0.5 }}>
          <BiCamera className='cursor-pointer text-[80px] text-blue-500 transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[100px]' />
        </motion.div>
